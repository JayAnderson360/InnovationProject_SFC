...
// Select the database (moved here to ensure it's always selected)
$conn->select_db($dbname);

// Create tables if they don't exist (moved here to ensure tables are always checked/created)
$tables = [
...
foreach ($tables as $query) {
    if (!$conn->query($query)) {
        throw new Exception("Error creating/checking table: " . $conn->error . " Query: " . $query);
    }
}
